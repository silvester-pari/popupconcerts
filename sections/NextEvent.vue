<template>
  <section id="frontpage-nextevent">
    ...
    <div class="frontpage-fb-eventcover">
      <a :href="eventLink" :title="eventTitle">
        <img class :src="eventCover" :alt="eventTitle">
      </a>
    </div>
    <div class="frontpage-nextevent-desktop-container">
      <h1># Next</h1>
      <a :href="eventLink" :title="eventTitle">
        <p class="frontpage-fb-eventdescription" v-html="eventDescription"></p>
      </a>

      <!-- <div class="button-row">
        <a :href="eventLink" :title="eventTitle" class="frontpage-fb-more btn btn-inverse">More</a>
        <button @click="addToCal" class="frontpage-addtocal btn btn-inverse">
      ...
      <button-row :location="'frontpage'"></button-row>
    </div>
  </section>
</template>
